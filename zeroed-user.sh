# First
pacman -S --noconfirm xorg xorg-xinit xorg-xprop xorg-xrandr xorg-server nvidia nvidia-utils nvidia-settings
cp /etc/X11/xinit/xinitrc .xinitrc

# Second
sudo pacman -S i3-gaps dmenu picom firefox terminator
 vim .xinitrc
